...
TILES = [
    ...
    # Die Aussage laesst sich durch keinen Screen belegen. Die hellste, leere
    # Flaeche traegt sie am besten, auch wenn sie dadurch zweimal vorkommt.
    ("2.jpg", "Kostenlos, mit einer\nkleinen Anzeige — per Kauf\nentfernbar.",
              "Free, with one small ad —\nremove it with a purchase."),
]
